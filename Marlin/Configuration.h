...
#define STRING_CONFIG_H_AUTHOR "(MiguelG, UofU)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "THz-LAB"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -9, -3 }
...
#define EVENT_GCODE_AFTER_HOMING "M300 P440 S200 G1 X0 Y0 Z20 F3000"  // Commands to run after G28 (and move to XY_AFTER_HOMING)
 ...
 */
#define EVENT_GCODE_AFTER_G29 "M420 S1 M300 P440 S200 G1 X0 Y0 Z20 F3000"
